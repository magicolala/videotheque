...
use Ced\VideothequeBundle\Form\FilmType;
...
class FilmController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $films = $em->getRepository('CedVideothequeBundle:Film')->findAll();
    ...
    {
        $film = new Film();
        $form = $this->createForm('Ced\VideothequeBundle\Form\FilmType', $film);
    ...
    {
        $deleteForm = $this->createDeleteForm($film);
        $editForm = $this->createForm('Ced\VideothequeBundle\Form\FilmType', $film);
