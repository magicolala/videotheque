...
use Ced\VideothequeBundle\Form\GenreType;
...
class GenreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $genres = $em->getRepository('CedVideothequeBundle:Genre')->findAll();
    ...
    {
        $genre = new Genre();
        $form = $this->createForm('Ced\VideothequeBundle\Form\GenreType', $genre);
    ...
    {
        $deleteForm = $this->createDeleteForm($genre);
        $editForm = $this->createForm('Ced\VideothequeBundle\Form\GenreType', $genre);
