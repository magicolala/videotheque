    ...
    */
    public function indexAction($label)
    {
        ...
        $selectedGenre = $entityManager
                            ->getRepository("CedVideothequeBundle:Genre")
                            ->findOneBy(array("nomLabel" => $label));
        ...
        $listeDeFilms = $entityManager
                            ->getRepository("CedVideothequeBundle:Film")
        ...
        $variables['total_nb_films'] = $entityManager->getRepository("CedVideothequeBundle:Film")->countAll();
        ...
        return $this->render('CedVideothequeBundle:Default:videotheque_home.html.twig', $variables);
    }
}
